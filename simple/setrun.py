...
#------------------------------
    ...
    probdata.add_param('rho1',     1.0,  'density in top layer')
    probdata.add_param('lam1',     1.0,  'lambda in top layer')
    probdata.add_param('mu1',     1.0,  'mu in top layer')
    probdata.add_param('rho2',     1.0,  'density in middle layer')
    probdata.add_param('lam2',     1.0,  'lambda in middle layer')
    probdata.add_param('mu2',     1.0,  'mu in middle layer')
    probdata.add_param('rho3',     1.0,  'density in bottom layer')
    probdata.add_param('lam3',     1.0,  'lambda in bottom layer')
    probdata.add_param('mu3',     1.0,  'mu in bottom layer')
    probdata.add_param('t0wall',     0.000,  'time duration of force')
    probdata.add_param('tperiod',     0.000,  'period of force')
    probdata.add_param('amplitude',   1.0,  'max amplitude of force')
    probdata.add_param('t0force',     0.005,  'time duration')
